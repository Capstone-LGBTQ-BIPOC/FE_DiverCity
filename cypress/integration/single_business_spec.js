describe('Going back functionality', () => {
  ...
  it('should display information for a single business', () => {
    ...
    cy.url('http://localhost:3000/biz/dKf_zc_gvlQJRXXZNkUNng')
      ...
      .and('contain', 'Hours:')
      .get('p')
      .should('contain', 'Monday: 07:00am - 9:00pm')
      .and('contain', 'Tuesday: 07:00am - 9:00pm')
      .and('contain', 'Wednesday: 07:00am - 9:00pm')
      .and('contain', 'Thursday: 07:00am - 10:00pm')
      .and('contain', 'Friday: 07:00am - 10:00pm')
      .and('contain', 'Saturday: 07:00am - 10:00pm')
      .and('contain', 'Sunday: 07:00am - 9:00pm')
      .get('h3')
