describe('Bookmark functionality', () => {
  beforeEach(() => {
    ...
    cy.intercept('GET', 'https://immense-falls-83363.herokuapp.com/api/v1/recommendations?business_id=B2i4QJY03Iqo7gxdCnJbiw', { fixture: 'sampleRecommendationData.json' }).as('recommendations')
